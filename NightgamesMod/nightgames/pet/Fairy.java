...
public class Fairy extends Pet {
    ...
    public Optional<String> instakillScene(Pet opponent) {
        ...
        if (switcher == getNum(Ptype.fairyfem, Ptype.fairyfem)) {
            return Optional.of("The two faeries circle around each other vying for the upper hand. " + own()
            ...
            return Optional.of("The faeries zip through the air like a couple dogfighting planes. " + opponent.own()
            ...
            return Optional.of(own() + " faerie flies between the legs of " + opponent.own()
            ...
            return Optional.of(opponent.own() + "imp grabs at " + own()
            ...
            return Optional.of(own() + "fae glows with magic as it circles " + opponent.own()
            ...
            return Optional.of(own() + "faerie boy chases " + opponent.own()
            ...
            return Optional.of(own() + "faerie chases " + opponent.own()
            ...
            return Optional.of(own() + " faerie gets under " + opponent.own()
            ...
            return Optional.of(own() + " Glows as he surrounds himself with magic before charging at "
                    + opponent.own()
