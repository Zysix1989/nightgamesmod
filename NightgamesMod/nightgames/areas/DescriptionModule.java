...
public class DescriptionModule {
    ...
    public static DescriptionModule quad() {
        return new DescriptionModule(QUAD_WHERE_AM_I);
    }
    ...
    public static DescriptionModule dorm() {
        return new DescriptionModule(DORM_WHERE_AM_I);
    }
    ...
    public static DescriptionModule shower() {
        return new DescriptionModule(SHOWER_WHERE_AM_I);
    }
    ...
    public static DescriptionModule laundry() {
        return new DescriptionModule(LAUNDRY_WHERE_AM_I);
    }
    ...
    public static DescriptionModule engineering() {
        return new DescriptionModule(ENGINEERING_WHERE_AM_I);
    }
    ...
    public static DescriptionModule lab() {
        return new DescriptionModule(LAB_WHERE_AM_I);
    }
    ...
    public static DescriptionModule workshop() {
        return new DescriptionModule(WORKSHOP_WHERE_AM_I);
    }
    ...
    public static DescriptionModule liberalArts() {
        return new DescriptionModule(LIBERAL_ARTS_WHERE_AM_I);
    }
    ...
    public static DescriptionModule pool() {
        return new DescriptionModule(POOL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule library() {
        return new DescriptionModule(LIBRARY_WHERE_AM_I);
    }
    ...
    public static DescriptionModule diningHall() {
        return new DescriptionModule(DINING_HALL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule kitchen() {
        return new DescriptionModule(KITCHEN_WHERE_AM_I);
    }
    ...
    public static DescriptionModule storage() {
        return new DescriptionModule(STORAGE_WHERE_AM_I);
    }
    ...
    public static DescriptionModule tunnel() {
        return new DescriptionModule(TUNNEL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule bridge() {
        return new DescriptionModule(BRIDGE_WHERE_AM_I);
    }
    ...
    public static DescriptionModule studentUnion() {
        return new DescriptionModule(STUDENT_UNION_WHERE_AM_I);
    }
    ...
    public static DescriptionModule courtyard() {
        return new DescriptionModule(COURTYARD_WHERE_AM_I);
    }
    ...
    public static DescriptionModule pond() {
        return new DescriptionModule(POND_WHERE_AM_I);
    }
    ...
    public static DescriptionModule glade() {
        return new DescriptionModule(GLADE_WHERE_AM_I);
    }
    ...
    public static DescriptionModule cabin() {
        return new DescriptionModule(CABIN_WHERE_AM_I);
    }
    ...
    public static DescriptionModule trail() {
        return new DescriptionModule(TRAIL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule lodge() {
        return new DescriptionModule(LODGE_WHERE_AM_I);
    }
    ...
    public static DescriptionModule hill() {
        return new DescriptionModule(HILL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule path() {
        return new DescriptionModule(PATH_WHERE_AM_I);
    }
    ...
    public static DescriptionModule oak() {
        return new DescriptionModule(OAK_WHERE_AM_I);
    }
    ...
    public static DescriptionModule pass() {
        return new DescriptionModule(PASS_WHERE_AM_I);
    }
    ...
    public static DescriptionModule waterfall() {
        return new DescriptionModule(WATERFALL_WHERE_AM_I);
    }
    ...
    public static DescriptionModule monument() {
        return new DescriptionModule(MONUMENT_WHERE_AM_I);
    }
    ...
    public static DescriptionModule dump() {
        return new DescriptionModule(DUMP_WHERE_AM_I);
    }
    ...
    public static DescriptionModule base(Participant p, String direction) {
        return new DescriptionModule(baseWhereAmI(p, direction));
    }
    ...
    public static DescriptionModule camp(Participant p) {
        return new DescriptionModule(campWhereAmI(p));
    }

    private final String whereAmI;

    private DescriptionModule(String whereAmI) {
