...
public class BehindFootjob extends AbstractBehindStance {
    ...
    public void struggle(Combat c, Character struggler) {
        if (struggler.hasDick()) {
            ...
            struggler.body.pleasure(top, top.body.getRandom(Body.FEET), struggler.body.getRandomCock(), Global.random(6, 11), c);
        } else {
            c.write(struggler, Global.format("{self:SUBJECT-ACTION:attempt} to twist out of {other:name-possessive} grip, but "
            ...
            struggler.body.pleasure(top, top.body.getRandom(Body.FEET), struggler.body.getRandomPussy(), Global.random(6, 11), c);
        }
