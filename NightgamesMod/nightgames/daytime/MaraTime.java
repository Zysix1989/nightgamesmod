            ...
            // The buttslut scene isn't fully written yet
                ...
                Global.gui()
                      .message("<i>\"Haha, yes! Great isn't it? Hands up!\"</i> You try to resist, "
                                      ...
                                      + " want to tell her that's not something " + Shorthand.guyOrGirl(Global.getPlayer()) + "s can really control like that, but inexplicably you feel "
            ...
            if (npc.getAffection(player) >= 8 && (!player.has(Trait.ticklemonster) || Global.random(2) == 1)) {
                Global.gui()
                      .message("You invite Mara to your room some fun. As soon as you get there she walks up behind you, shoves her hand down the front of your pants, and grabs you penis. "
                                      ...
                                      + "your balls. <i>\"" +Global.capitalizeFirstLetter(Shorthand.boyOrGirl(Global.getPlayer())) + "s get really nervous when I play with these, but it feels good, doesn't it?\"</i> She's mostly back to her typical, mischievous self, but you can see a "
            ...
            if (npc.getAffection(player) >= 16 && (!player.has(Trait.spider) || Global.random(2) == 1)) {
                ...
                Global.gui()
                      .message("You knew Mara was clever, but you didn't expect playing a board game against her to be this frustrating. Every move you make, she seems to have planned far "
                                      ...
                                      + "really seem like you did anything worse than what she was doing just seconds ago. <i>\"It's completely different. If you tease a " + Shorthand.boyOrGirl(Global.getPlayer()) + ", he just gets hard and then you have something else to "
            ...
            if (npc.getAffection(player) >= 12 && (!player.has(Trait.heeldrop) || Global.random(2) == 1)) {
                Global.gui()
                      .message("You and Mara prepare for some sparring practice by getting undressed. She tosses her clothes aside and is so eager that she's actually bouncing noticeably, "
                                      ...
                                      + "and hitting it as hard as I can.\"</i> She leans down and softly kisses you on the lips. <i>\"Unfortunately, sometimes that means hurting a " + Shorthand.boyOrGirl(Global.getPlayer()) + " I like a lot.\"</i><br/><br/>By now, the pain in your groin "
