    ...
    private void executeCommand(CommandType chosen, Combat c, Character target) {
        ...
        switch (chosen) {
            ...
            case MASTURBATE:
                ...
                target.body.pleasure(target, target.body.getRandomHands(), pleasured, 10 + Global.random(20), c, this);
                break;
            case HURT_SELF:
                c.write(getSelf(),
            ...
            case WORSHIP_COCK:
                ...
                if (target.hasDick())
                    ...
                    target.body.pleasure(target, target.body.getRandomHands(), target.body.getRandomPussy(),
                                    10 + Global.random(8), c, this);
                break;
            case WORSHIP_PUSSY:
                c.write(getSelf(),
