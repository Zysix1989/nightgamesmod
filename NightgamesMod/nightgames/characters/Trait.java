        ...
        resistances.put(Trait.calm, (combat, c, s) -> {
            ...
            if ((s.flags().contains(Stsflag.horny) || s.flags().contains(Stsflag.hypersensitive))
                ...
                if (s.flags().contains(Stsflag.piercingOdor) && s instanceof Pheromones) {
                    ...
                    combat.write(c, "The piercing scent of the pheromones overpowers " + c.possessiveAdjective() + " cool-headedness. While it doesn't affect " + c.objectPronoun()+ " as much as it should, it's still impossible to just shrug off.");
                    return "";
                }
                return "Calm";
            }
