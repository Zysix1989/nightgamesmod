...
public class Jewel extends BasePersonality {
    ...
    public void applyBasicStats(Character self) {
        preferredCockMod = Optional.of(new EnlightenedCockMod());
    ...
    public void advance() {
        ...
        if (character.hasPussy()) {
            character.body.getRandomPussy().addMod(new FieryMod());
        }
        if (character.hasDick()) {
            character.body.getRandomCock().addMod(new EnlightenedCockMod());
        }
